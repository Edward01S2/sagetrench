<header class="banner bg-white shadow lg:fixed lg:w-full lg:z-30">
  <div class="container mx-auto">
    <nav class="flex items-center justify-between flex-wrap py-2 lg:flex-no-wrap xl:px-0">
        ...
        <div class="text-sm relative w-full md:w-auto">
          <div class="absolute w-full text-center mt-2 md:static md:w-auto md:mt-0">
            <div class="h-full w-full absolute bg-white z-10 shadow md:static md:bg-none md:w-auto"></div>
              ...
              @endif
              <a class="hidden search-button outline-none focus:outline-none md:flex md:items-center ml-2 lg:ml-6" href="/?s=">
                <svg class="h-5 w-5 fill-current text-s-stone ml-2 hover:text-s-yellow outline-none active:outline-none" height="1" width="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.9 14.32a8 8 0 1 1 1.41-1.41l5.35 5.33-1.42 1.42-5.33-5.34zM8 14A6 6 0 1 0 8 2a6 6 0 0 0 0 12z"/></svg>
              </a>
              <div class="md:hidden">
                <?php get_search_form(); ?>
              </div>
